...
/**
 * Strings for component 'auth_fc', language 'hu', version '3.10'.
 *
 * @package     auth_fc
 * @category    string
...
$string['auth_fcconnfail'] = '{$a->no} számú, {$a->str} miatti kapcsolódási hiba';
...
$string['pluginname'] = 'FirstClass szerver';
$string['privacy:metadata'] = 'A FirstClass kiszolgáló hitelesítési segédprogram semmilyen személyes adatot nem tárol.';
