...
/**
 * Strings for component 'countries', language 'hu', version '3.10'.
 *
 * @package     countries
 * @category    string
...
$string['BM'] = 'Bermuda';
$string['BN'] = 'Brunei';
$string['BO'] = 'Bolíviai Többnemzetiségű Állam';
$string['BQ'] = 'Karibi Hollandia';
$string['BR'] = 'Brazília';
...
$string['FM'] = 'Mikronéziai Szövetségi Államok';
$string['FO'] = 'Feröer-szigetek';
...
$string['IQ'] = 'Irak';
$string['IR'] = 'Iráni Iszlám Köztársaság';
$string['IS'] = 'Izland';
...
$string['KN'] = 'Saint Christopher és Nevis Államszövetség';
...
$string['MF'] = 'Saint-Martin (francia rész)';
$string['MG'] = 'Madagaszkár';
$string['MH'] = 'Marshall-szigetek';
$string['MK'] = 'Észak-macedón Köztársaság';
$string['ML'] = 'Mali';
$string['MM'] = 'Mianmar';
$string['MN'] = 'Mongólia';
$string['MO'] = 'Makaó';
...
$string['SG'] = 'Szingapúr';
$string['SH'] = 'Saint Helena, Ascension és Tristan Da Cunha';
$string['SI'] = 'Szlovénia';
...
$string['SO'] = 'Szomália';
$string['SR'] = 'Suriname';
$string['SS'] = 'Dél-Szudán';
$string['ST'] = 'Sao Tomé és Príncipe';
$string['SV'] = 'Salvador';
$string['SX'] = 'Sint Maarten (holland rész)';
$string['SY'] = 'Szíria';
...
$string['VE'] = 'Venezuelai Bolivári Köztársaság';
