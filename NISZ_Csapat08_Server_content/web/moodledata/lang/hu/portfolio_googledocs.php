...
/**
 * Strings for component 'portfolio_googledocs', language 'hu', version '3.10'.
 *
...
$string['nooauthcredentials_help'] = 'A Google Drive portfólió segédprogramjának használatához a portfólió beállításaiban konfigurálni kell az OAuth paramétereit.';
$string['nosessiontoken'] = 'Hiányzik egy folyamatjel, így nem sikerül a Google-ba való exportálás.';
...
$string['privacy:metadata'] = 'Ez a segédprogram kapcsolódó Google-fiókhoz továbbít adatokat külsőleg, helyben nem tárol adatokat.';
$string['privacy:metadata:data'] = 'A portfólió alrendszertől érkező személyes adatok.';
$string['secret'] = 'Titkos';
$string['sendfailed'] = 'A(z) {$a} állomány átvitele a Google-ba nem sikerült.';
