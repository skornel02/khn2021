...
/**
 * Strings for component 'portfolio_mahara', language 'hu', version '3.10'.
 *
...
$string['err_networkingoff_help'] = 'A Moodle hálózati hitelesítés ki van kapcsolva. A segédprogram beállítása előtt kapcsolja be. A segédprogram minden példánya a hiba elhárításáig láthatatlanra van állítva - kézzel kell ismét láthatóra állítania őket.';
...
$string['privacy:metadata'] = 'Ez a segédprogram kapcsolódó Mahara alkalmazáshoz továbbít adatokat külsőleg, helyben nem tárol adatokat.';
