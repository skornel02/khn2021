...
/**
 * Strings for component 'qtype_calculated', language 'hu', version '3.10'.
 *
...
$string['answerdisplay'] = 'Válasz megjelenítése';
$string['answerformula'] = '{$a}. képlethez kapcsolódó válasz';
...
$string['calcdistribution'] = 'Eloszlás';
...
$string['choosedatasetproperties_help'] = 'Az adatkészlet olyan értékek készlete, amelyek a helyettesítő karakterek helyére kerülnek. Létrehozhat egy egyedi adatkészletet egy konkrét kérdéshez, vagy egy közös adatkészletet, amelyet a kategórián belül más számításos kérdésekhez is felhasználhat.';
...
$string['distributionoption'] = 'Válassza ki az eloszlást';
$string['editdatasets'] = 'Helyettesítő karakterek adatkészleteinek szerkesztése';
$string['editdatasets_help'] = 'Helyettesítő értékeket az egyes helyettesítő mezőkbe beírt számmal, majd a Hozzáadás gombra kattintással hozhat létre. 10 vagy több érték automatikus létrehozásához a Hozzáadás gombra kattintás előtt válassza ki a szükséges számértékeket. Egyenletes eloszlás esetén a határértékeken belül bármely érték azonos valószínűséggel áll elő. Logaritmikus eloszlásból származó számjegyek esetén az alsó határértékhez közelítő értékek megjelenésének nagyobb a valószínűsége.';
...
$string['existingcategory3'] = 'A kategórián belül más kérdésekben már használt ugrópontok készletének egyik hivatkozása';
...
$string['keptcategory3'] = 'Ugyanazon korábbi kategóriába tartozó újrahasználható hivatkozáskészletéből egy hivatkozás';
...
$string['keptlocal3'] = 'Kérdések ugyanazon korábbi magán-hivatkozástkészletéből egy hivatkozás';
$string['lengthoption'] = 'Válassza ki a hosszúságot';
$string['loguniform'] = 'Logaritmikus';
$string['loguniformbit'] = 'logaritmikus eloszlás számjegyei';
...
$string['newcategory3'] = 'A kategórián belül más kérdésekben is használható hivatkozások új készletének egyik hivatkozása';
...
$string['newlocal3'] = 'Kizárólag a kérdésben használandó hivatkozások új készletének egyik hivatkozása';
...
$string['nocoherencequestionsdatyasetcategory'] = 'A(z) {$a->qid} azonosítójú kérdés esetén a(z) {$a->qcat} kategória-azonosító nem egyezik a közös {$a->name} helyettesítő karakter {$a->sharedcat} kategória-azonosítójával. Szerkessze meg a kérdést.';
...
$string['privacy:metadata'] = 'A Calculated question type segédprogram semmilyen személyes adatot nem tárol.';
...
$string['uniform'] = 'Egyenletes';
$string['uniformbit'] = 'egyenletes eloszlás tizedesei';
...
$string['wildcardrole'] = 'A(z) {x..} helyettesítő karakterek helyére az előállított értékekből kapott számérték kerül';
