...
/**
 * Strings for component 'qtype_numerical', language 'hu', version '3.10'.
 *
...
$string['answercolon'] = 'Válasz';
$string['answererror'] = 'Hiba';
$string['answermustbenumberorstar'] = 'A válasz szám, pl. -1.234 vagy 3e8, illetve \'*\' lehet.';
$string['answerno'] = '{$a} válasz';
$string['decfractionofquestiongrade'] = 'A kérdésre adott pont (0-1) törtrésze';
$string['decfractionofresponsegrade'] = 'A válaszra adott pont  (0-1) törtrésze';
...
$string['privacy:metadata'] = 'A Numerical question type segédprogram semmilyen személyes adatot nem tárol.';
...
$string['unitnotselected'] = 'Nincs kiválasztva mértékegység';
...
$string['unitposition'] = 'Mértékegységek helyzete';
$string['units'] = 'Egység';
$string['unitselect'] = 'lenyíló menü';
$string['unitx'] = 'Egység  {no}';
...
* ha az ezreseket a nyelvi csomag beállításaiban (langconfig.php file) vessző (,) választja el, *mindig* . legyen a tizedesjel, pl. 13,500.67 : 13,500.
...
$string['xmustbenumeric'] = '{$a} kötelezően szám';
$string['xmustnotbenumeric'] = '{$a} nem lehet szám';
