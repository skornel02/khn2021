...
/**
 * Strings for component 'workshopallocation_random', language 'hu', version '3.10'.
 *
...
$string['numofrandomlyallocatedsubmissions'] = '{$a} véletlenszerű hozzárendelése';
...
$string['privacy:metadata'] = 'A Random allocation segédprogram nem tárol személyes adatokat. A ki kit értékel aktuális személyes adatait maga a Műhelymodul tárolja, ez képezi az értékelési adatok exportálásának az alapját.';
...
$string['resultnumperreviewer'] = 'Értékelőnként {$a} értékelés hozzárendelése';
